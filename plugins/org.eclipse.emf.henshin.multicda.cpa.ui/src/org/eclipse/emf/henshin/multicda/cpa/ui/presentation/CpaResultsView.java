...
/**
 * This view lists the result of a conflict reason analysis run and provides the ability to open the conjugate files of a
...
public class CpaResultsView extends ViewPart {
	...
	private HashMap<String, Set<ConflictReasonNode>> content;
	...
	class CPAViewContentProvider implements ITreeContentProvider {
		...
		void initialize() {
			...
			for (String ruleCombinationName : content.keySet()) {
				...
				Set<ConflictReasonNode> theCriticalPairsForTheRulecombination = content.get(ruleCombinationName);

				for (ConflictReasonNode criticalPairNode : theCriticalPairsForTheRulecombination) {
		...
		public Object getParent(Object element) {
			if (element instanceof ConflictReasonNode) {
				return ((ConflictReasonNode) element).getParent();
			}
			return null;
		}
	...
	private void makeActions() {
		...
		doubleClickAction = new Action() {
			public void run() {
				...
				if (obj instanceof ConflictReasonNode) {

					ConflictReasonNode criticalPairNode = (ConflictReasonNode) obj;
	...
	public void setContent(HashMap<String, Set<ConflictReasonNode>> persistedResults) {
