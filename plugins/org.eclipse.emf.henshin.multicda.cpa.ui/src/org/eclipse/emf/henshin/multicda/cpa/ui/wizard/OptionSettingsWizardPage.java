...
public class OptionSettingsWizardPage extends WizardPage {
	...
	private final static String COMPLETE = "complete conflict reasons (if not selected, search up to first critical match)";
	private final static String IGNOREIDENTICALRULES = "ignore conflict reasons of same rules";
	private final static String REDUCESAMEMATCH = "ignore conflict reasons of same rules and same matches";

	/**
	 * Default Constructor for the second page of the wizard. This page provides the functionality to adapt the options
	 * for the conflict reason analysis.
	 * 
	...
	public OptionSettingsWizardPage(String pageName, String optionsFile) {
		super(pageName);
		setTitle("Conflict Reason Analysis - Option Settings");
