...
public class RuleAndCpKindSelectionWizardPage extends WizardPage {
	...
	public RuleAndCpKindSelectionWizardPage(HashMap<Rule, String> rulesAndAssociatedFileNames) {
		super("Precondition");
		setTitle("Conflict Reason Analysis - Rule selection");
	 ...
	 * containing a button for each rule to select or deselect it. On the right side the conflictReasonKindGroup to select
	...
	public void createControl(Composite parent) {
		...
		Group conflictReasonKindGroup = new Group(containerForBothGroups, SWT.TOP);
		conflictReasonKindGroup.setLayout(new GridLayout());
		conflictReasonKindGroup.setText("Calculate...");
		...
		Button conflictAnalysisButton = new Button(conflictReasonKindGroup, SWT.CHECK);
		...
		Button dependencyAnalysisButton = new Button(conflictReasonKindGroup, SWT.CHECK);
	 ...
	 * 
	 * @return returns <code>true</code> for conflict reasons or <code>false</code> for Dependencies
	 */
