 ...
 * @generated
 */
public class AlgebraUseSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AlgebraUsePackage.OPERATION_PARAMETER: {
				OperationParameter operationParameter = (OperationParameter)theEObject;
				T result = caseOperationParameter(operationParameter);
				if (result == null) result = caseAnnotatedElem(operationParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgebraUsePackage.DATA_ELEMENT: {
				DataElement dataElement = (DataElement)theEObject;
				T result = caseDataElement(dataElement);
				if (result == null) result = caseOperationParameter(dataElement);
				if (result == null) result = caseAnnotatedElem(dataElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgebraUsePackage.ATTRIBUTE_USE: {
				AttributeUse attributeUse = (AttributeUse)theEObject;
				T result = caseAttributeUse(attributeUse);
				if (result == null) result = caseOperationParameter(attributeUse);
				if (result == null) result = caseAnnotatedElem(attributeUse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgebraUsePackage.OPERATION_USE: {
				OperationUse operationUse = (OperationUse)theEObject;
				T result = caseOperationUse(operationUse);
				if (result == null) result = caseOperationParameter(operationUse);
				if (result == null) result = caseAnnotatedElem(operationUse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Operation Use</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Operation Use</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOperationUse(OperationUse object) {
		return null;
	}
