...
public class TransformationSystemCanonicalEditPolicy extends
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				HenshinLinkDescriptor nextLinkDescriptor = (HenshinLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final HenshinLinkDescriptor nextLinkDescriptor = (HenshinLinkDescriptor) linkDescriptorsIterator
					.next();
