 ...
 * @generated
 */
public class HenshinMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = HenshinDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			HenshinDiagramEditorUtil.selectElementsInDiagram(editor,
