 ...
 * @generated
 */
public class NacAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected NacSwitch<Adapter> modelSwitch =
		new NacSwitch<Adapter>() {
			@Override
			public Adapter caseNegativeApplicationCondition(NegativeApplicationCondition object) {
				return createNegativeApplicationConditionAdapter();
			}
			@Override
			public Adapter caseMatchWithNacs(MatchWithNacs object) {
				return createMatchWithNacsAdapter();
			}
			@Override
			public Adapter caseGraphWithNacs(GraphWithNacs object) {
				return createGraphWithNacsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.sam.invcheck.nac.NegativeApplicationCondition <em>Negative Application Condition</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.sam.invcheck.nac.MatchWithNacs <em>Match With Nacs</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMatchWithNacsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.sam.invcheck.nac.GraphWithNacs <em>Graph With Nacs</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGraphWithNacsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.sam.invcheck.nac.PatternNode <em>Pattern Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.sam.invcheck.nac.PatternEdge <em>Pattern Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
