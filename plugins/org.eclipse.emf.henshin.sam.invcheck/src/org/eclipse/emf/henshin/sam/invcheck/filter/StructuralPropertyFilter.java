...
public class StructuralPropertyFilter extends
		FilterSkeleton<GraphVerificationData, GraphVerificationData> {
	...
	public void produce() {
		...
		/*if (true) {
			GraphVerificationData result = new GraphVerificationData(
		...
		//System.out.println(this.currentInput.sourceGraph.getNodes().size() + "::" + this.currentInput.sourceGraph.getEdges().size());
		if (this.internalHelper.findProperties(this.currentInput.sourceGraph)) {
			discarded++;
			//System.out.println(this.currentInput.pair.second.getName() + " " + ((NegatedCondition) this.currentInput.pair.first.eContainer().eContainer()).getName() + " discarded");
			if (nacDiscard != tmp) {
				//System.out.println("spf " + this.currentInput.pair.second.getName() + " " + ((NegatedCondition) this.currentInput.pair.first.eContainer().eContainer()).getName());
				//System.out.println(this.currentInput.sourceGraph.getNodes().size() + "::" + this.currentInput.sourceGraph.getEdges().size());
			}
