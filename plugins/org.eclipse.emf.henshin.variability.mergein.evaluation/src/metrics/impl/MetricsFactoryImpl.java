...
public class MetricsFactoryImpl extends EFactoryImpl implements MetricsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MetricsPackage.RULE_SET_METRICS: return createRuleSetMetrics();
			case MetricsPackage.RULE_METRICS: return createRuleMetrics();
			default:
	 ...
	 * @generated
	 */
	public RuleSetMetrics createRuleSetMetrics() {
		RuleSetMetricsImpl ruleSetMetrics = new RuleSetMetricsImpl();
	 ...
	 * @generated
	 */
	public RuleMetrics createRuleMetrics() {
		RuleMetricsImpl ruleMetrics = new RuleMetricsImpl();
		return ruleMetrics;
	}
