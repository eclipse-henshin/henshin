...
public class MetricsAdapterFactory extends AdapterFactoryImpl {
	...
	protected MetricsSwitch<Adapter> modelSwitch =
		new MetricsSwitch<Adapter>() {
			@Override
			public Adapter caseRuleSetMetrics(RuleSetMetrics object) {
				return createRuleSetMetricsAdapter();
			}
			@Override
			public Adapter caseRuleMetrics(RuleMetrics object) {
				return createRuleMetricsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link metrics.RuleSetMetrics <em>Rule Set Metrics</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuleSetMetricsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link metrics.RuleMetrics <em>Rule Metrics</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuleMetricsAdapter() {
		return null;
	}
