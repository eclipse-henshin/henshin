 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.henshin.model.impl.IndependentUnitImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.henshin.model.impl.IndependentUnitImpl#isActivated <em>Activated</em>}</li>
 *   <li>{@link org.eclipse.emf.henshin.model.impl.IndependentUnitImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link org.eclipse.emf.henshin.model.impl.IndependentUnitImpl#getPortMappings <em>Port Mappings</em>}</li>
 ...
 * @generated
 */
public class IndependentUnitImpl extends DescribedElementImpl implements IndependentUnit {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.INDEPENDENT_UNIT__NAME, oldName, name));
	}
	...
	public void setActivated(boolean newActivated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.INDEPENDENT_UNIT__ACTIVATED, oldActivated, activated));
	}
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentWithInverseEList<Port>(Port.class, this, HenshinPackage.INDEPENDENT_UNIT__PORTS, HenshinPackage.PORT__UNIT);
		}
		return ports;
	}
	...
	public EList<PortMapping> getPortMappings() {
		if (portMappings == null) {
			portMappings = new EObjectContainmentEList<PortMapping>(PortMapping.class, this, HenshinPackage.INDEPENDENT_UNIT__PORT_MAPPINGS);
		}
		return portMappings;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HenshinPackage.INDEPENDENT_UNIT__PORTS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case HenshinPackage.INDEPENDENT_UNIT__PORT_MAPPINGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HenshinPackage.INDEPENDENT_UNIT__NAME:
				return getName();
			case HenshinPackage.INDEPENDENT_UNIT__ACTIVATED:
				return isActivated();
			case HenshinPackage.INDEPENDENT_UNIT__PORTS:
				return getPorts();
			case HenshinPackage.INDEPENDENT_UNIT__PORT_MAPPINGS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case HenshinPackage.INDEPENDENT_UNIT__NAME: return HenshinPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case HenshinPackage.NAMED_ELEMENT__NAME: return HenshinPackage.INDEPENDENT_UNIT__NAME;
				default: return -1;
			}
		}
