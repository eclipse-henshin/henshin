 ...
 * </copyright>
 *
 * $Id: IndependentUnitImpl.java,v 1.1 2009/10/28 10:38:13 enrico Exp $
 */
 ...
 * @generated
 */
public class IndependentUnitImpl extends EObjectImpl implements IndependentUnit {
	/**
	...
	public EList<TransformationUnit> getSubUnits() {
		if (subUnits == null) {
			subUnits = new EObjectContainmentEList<TransformationUnit>(TransformationUnit.class, this, HenshinPackage.INDEPENDENT_UNIT__SUB_UNITS);
		}
		return subUnits;
	}
