...
public class InputDataChecker {
	...
	/**
	 * Checks the list of rules in regard of being suitable for applying this conflict reason analysis implementation.
	 * 
	 * @param rules The rules to be checked in regard of being suitable for applying this conflict reason analysis
	 *            implementation.
	 * @return <code>true</code> if all of the rules are suitable for applying this conflict reason analysis
	 *         implementation.
