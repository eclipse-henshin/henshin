 ...
 * AGG and the nodes in the two Henshin rules forming the conflict reason.
 * 
 * @author Kristopher Born
 *
 */
public class ConflictGraphMapping {
	 ...
	 * Default constructor.
	 */
	public ConflictGraphMapping() {
		mappings = new LinkedList<ConflictGraphMapping.Mapping>();
	}
