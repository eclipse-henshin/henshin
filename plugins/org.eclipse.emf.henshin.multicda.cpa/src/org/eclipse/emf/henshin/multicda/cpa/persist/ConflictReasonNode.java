...
/**
 * This class links the different files composing a conflict reason within the file system.
 * 
 * @author Kristopher Born
 *
 */
public class ConflictReasonNode {
	 ...
	 */
	public ConflictReasonNode(String numberedNameOfCPKind, URI firstRuleURI, URI secondRuleURI, URI minimalModelURI,
			URI criticalPairURI) {
