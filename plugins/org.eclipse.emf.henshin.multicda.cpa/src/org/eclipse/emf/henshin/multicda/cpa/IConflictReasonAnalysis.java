...
/**
 * Interface for executing the conflict reason analysis on a set of Henshin rules.
 * 
 * @author Florian Heﬂ, Kristopher Born
 *
 */
public interface IConflictReasonAnalysis {

	/**
	 * Initializes the conflict reason calculation with the <code>rules</code> parameter, used as first and second rules as well as the <code>options</code>.
	 * 
	 ...
	 * of the conflict reasons as well as the <code>options</code>.
	 * 
