 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.emf.henshin.text.henshin_text.impl.IndependentUnitImpl#getListOfLists <em>List Of Lists</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndependentUnitImpl extends UnitElementImpl implements IndependentUnit
{
  /**
  ...
  {
    return Henshin_textPackage.Literals.INDEPENDENT_UNIT;
  }
  ...
  public EList<List> getListOfLists()
  {
    if (listOfLists == null)
    {
      listOfLists = new EObjectContainmentEList<List>(List.class, this, Henshin_textPackage.INDEPENDENT_UNIT__LIST_OF_LISTS);
    }
    return listOfLists;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Henshin_textPackage.INDEPENDENT_UNIT__LIST_OF_LISTS:
