		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortMapping_source_feature", "_UI_PortMapping_type"),
				 HenshinPackage.Literals.PORT_MAPPING__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortMapping_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortMapping_target_feature", "_UI_PortMapping_type"),
				 HenshinPackage.Literals.PORT_MAPPING__TARGET,
				 true,
				 false,
				 true,
				 null,
