 ...
 * @generated
 */
public class IndependentUnitItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HenshinPackage.Literals.INDEPENDENT_UNIT__SUB_UNITS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IndependentUnit.class)) {
