...
/**
 * This class introduces an adaption of the <code>MatchImpl</code> to serve within the context of this critical pair analysis.
 * "comatch" defines the situation where the RHS (right hand side) of a rule is mapped into a model instead of the usual LHS (left ahnd side).
 * 
