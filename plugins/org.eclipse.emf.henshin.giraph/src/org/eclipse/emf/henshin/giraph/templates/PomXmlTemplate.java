...
public class PomXmlTemplate
{
  ...
  protected final String TEXT_2 = "</artifactId>" + NL + "\t<packaging>jar</packaging>" + NL + "" + NL + "\t<name>Henshin Giraph Examples</name>" + NL + "\t<description>Generated example Henshin Giraph code</description>" + NL + "\t<url>https://wiki.eclipse.org/Henshin_Code_Generator_for_Giraph</url>" + NL + "\t<inceptionYear>2014</inceptionYear>" + NL + "" + NL + "\t<properties>" + NL + "\t\t<top.dir>${project.basedir}/..</top.dir>" + NL + "\t\t<forHadoop>for-hadoop-${hadoop.version}</forHadoop>" + NL + "\t</properties>" + NL + "" + NL + "\t<build>" + NL + "\t\t<finalName>";
