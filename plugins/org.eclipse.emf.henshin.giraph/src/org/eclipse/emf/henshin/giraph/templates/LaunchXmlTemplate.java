...
public class LaunchXmlTemplate
{
  ...
  protected final String TEXT_3 = NL + "\t</description>" + NL + "" + NL + "\t<include file=\"../launch-env.xml\" />" + NL + "\t" + NL + "\t<property name=\"hadoop.cmd\" value=\"${hadoop.home}/bin/hadoop\" />" + NL + "" + NL + "\t<target name=\"main\">" + NL + "\t\t<exec executable=\"${hadoop.home}/bin/start-dfs.sh\" failonerror=\"true\" />" + NL + "\t\t<exec executable=\"${hadoop.home}/bin/start-mapred.sh\" failonerror=\"true\" />" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"dfsadmin\" />" + NL + "\t\t\t<arg value=\"-safemode\" />" + NL + "\t\t\t<arg value=\"leave\" />" + NL + "\t\t</exec>" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"fs\" />" + NL + "\t\t\t<arg value=\"-mkdir\" />" + NL + "\t\t\t<arg value=\"/input\" />" + NL + "\t\t</exec>" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"fs\" />" + NL + "\t\t\t<arg value=\"-put\" />" + NL + "\t\t\t<arg value=\"../input/";
  ...
  protected final String TEXT_12 = "$MasterCompute\" />" + NL + "\t\t</exec>" + NL + "\t\t<delete dir=\"../output\" />" + NL + "\t\t<mkdir dir=\"../output\" />" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"fs\" />" + NL + "\t\t\t<arg value=\"-get\" />" + NL + "\t\t\t<arg value=\"/output/*\" />" + NL + "\t\t\t<arg value=\"../output\" />" + NL + "\t\t</exec>" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"fs\" />" + NL + "\t\t\t<arg value=\"-rmr\" />" + NL + "\t\t\t<arg value=\"/input\" />" + NL + "\t\t</exec>" + NL + "\t\t<exec executable=\"${hadoop.cmd}\">" + NL + "\t\t\t<arg value=\"fs\" />" + NL + "\t\t\t<arg value=\"-rmr\" />" + NL + "\t\t\t<arg value=\"/output\" />" + NL + "\t\t</exec>" + NL + "\t\t<exec executable=\"${hadoop.home}/bin/stop-all.sh\" failonerror=\"true\" />" + NL + "\t</target>" + NL + "" + NL + "</project>";
