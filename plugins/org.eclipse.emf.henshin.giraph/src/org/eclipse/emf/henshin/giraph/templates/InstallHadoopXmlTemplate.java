...
public class InstallHadoopXmlTemplate
{
  ...
  protected final String TEXT_3 = ":54311&lt;/value&gt;&#10;&lt;/property&gt;&#10;&#10;&lt;property&gt;&#10;&lt;name&gt;mapred.tasktracker.map.tasks.maximum&lt;/name&gt;&#10;&lt;value&gt;4&lt;/value&gt;&#10;&lt;/property&gt;&#10;&#10;&lt;property&gt;&#10;&lt;name&gt;mapred.map.tasks&lt;/name&gt;&#10;&lt;value&gt;4&lt;/value&gt;&#10;&lt;/property&gt;&#10;&lt;/configuration&gt;&#10;\" />" + NL + "\t\t<replaceregexp file=\"${hadoop.folder}/conf/hdfs-site.xml\" flags=\"g\" match=\"&lt;configuration&gt;\\s*&lt;/configuration&gt;\" replace=\"&lt;configuration&gt;&#10;&lt;property&gt;&#10;&lt;name&gt;dfs.replication&lt;/name&gt;&#10;&lt;value&gt;1&lt;/value&gt;&#10;&lt;/property&gt;&#10;&lt;/configuration&gt;&#10;\" />" + NL + "\t\t<replaceregexp file=\"${hadoop.folder}/conf/master\" match=\"localhost\" replace=\"";
  protected final String TEXT_4 = "\" />" + NL + "\t\t<replaceregexp file=\"${hadoop.folder}/conf/slaves\" match=\"localhost\" replace=\"";
  protected final String TEXT_5 = "\" />" + NL + "\t\t<delete dir=\"${hadoop.tmpdir}\" />" + NL + "\t\t<mkdir dir=\"${hadoop.tmpdir}\" />" + NL + "\t\t<echo message=\"Formatting namenode...\" />" + NL + "\t\t<exec executable=\"${hadoop.folder}/bin/hadoop\" failonerror=\"true\">" + NL + "\t\t\t<arg value=\"namenode\" />" + NL + "\t\t\t<arg value=\"-format\" />" + NL + "\t\t</exec>" + NL + "\t\t<echo message=\"Checking public-key login to ";
  ...
  protected final String TEXT_7 = "\" />" + NL + "\t\t\t<arg value=\"echo\" />" + NL + "\t\t\t<arg value=\"OK\" />" + NL + "\t\t</exec>" + NL + "\t</target>" + NL + "" + NL + "\t<target name=\"clean\">" + NL + "\t\t<delete file=\"${hadoop.archive}\" />" + NL + "\t\t<delete dir=\"${hadoop.tmpdir}\" />" + NL + "\t</target>" + NL + "" + NL + "</project>";
