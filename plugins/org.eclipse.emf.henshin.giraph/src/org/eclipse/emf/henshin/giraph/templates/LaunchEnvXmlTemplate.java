...
public class LaunchEnvXmlTemplate
{
  ...
  protected final String TEXT_1 = "<project name=\"launch-env\">" + NL + "\t<description>" + NL + "\t\tCommon properties for launch environment" + NL + "\t</description>" + NL + "" + NL + "\t<property name=\"java.home\" location=\"";
  protected final String TEXT_2 = "\" />" + NL + "\t<property name=\"hadoop.home\" location=\"";
  protected final String TEXT_3 = "\" />" + NL + "\t<property name=\"giraph.jar.with.deps\" location=\"";
