...
public class GetLibsLaunchTemplate
{
  ...
  protected final String TEXT_3 = "/lib/get-libs.xml}\"/>" + NL + "<stringAttribute key=\"org.eclipse.ui.externaltools.ATTR_RUN_BUILD_KINDS\" value=\"full,incremental,\"/>" + NL + "<booleanAttribute key=\"org.eclipse.ui.externaltools.ATTR_TRIGGERS_CONFIGURED\" value=\"true\"/>" + NL + "<stringAttribute key=\"org.eclipse.ui.externaltools.ATTR_WORKING_DIRECTORY\" value=\"${workspace_loc:/";
  protected final String TEXT_4 = "/lib}\"/>" + NL + "</launchConfiguration>";
