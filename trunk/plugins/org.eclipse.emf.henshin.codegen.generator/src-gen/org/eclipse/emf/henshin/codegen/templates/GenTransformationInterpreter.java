...
public class GenTransformationInterpreter
{
  ...
  protected final String TEXT_7 = NL + NL + "import org.eclipse.emf.ecore.EObject;" + NL + "import org.eclipse.emf.ecore.resource.Resource;" + NL + "import org.eclipse.emf.ecore.resource.ResourceSet;" + NL + "" + NL + "import org.eclipse.emf.henshin.common.util.EmfGraph;" + NL + "import org.eclipse.emf.henshin.interpreter.*;" + NL + "import org.eclipse.emf.henshin.model.*;" + NL + "" + NL + "/**" + NL + " * @generated" + NL + " */" + NL + "public class ";
