...
This example contains two features: 

(1) It shows how to define higher-order (HO) transformations in Henshin, and

(2) A benchmark for the match finder in Henshin.
