...
public class GiraphRuleTemplate
{
  ...
  protected final String TEXT_53 = NL + "          matchCount++;" + NL + "          // Send the message back to match of node ";
  ...
  protected final String TEXT_59 = NL + "          match = match.remove(";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "          if (!finalMatches.add(match)) {" + NL + "            continue;" + NL + "          }" + NL + "          matchCount++;" + NL + "          if (segment == SEGMENT_COUNT - 1) {" + NL + "            apply";
  protected final String TEXT_62 = "(" + NL + "              vertex, match, appCount++);" + NL + "          } else {" + NL + "            sendMessage(vertex.getId(), match);" + NL + "          }";
  protected final String TEXT_63 = NL + "        }" + NL + "      }";
  protected final String TEXT_64 = NL + "      // Matching node ";
  protected final String TEXT_65 = ":";
  protected final String TEXT_66 = NL + "      ";
  protected final String TEXT_67 = "vertex.getValue().get() == ";
  protected final String TEXT_68 = NL + "      ok = ok && vertex.getNumEdges() >= ";
  protected final String TEXT_69 = ";";
  protected final String TEXT_70 = NL + "      ok = ok && (SEGMENT_COUNT == 1 || getSegment(vertex.getId()) == segment);";
  protected final String TEXT_71 = NL + "      if (ok) {";
  protected final String TEXT_72 = NL + "        Match match = new Match(segment).append(vertex.getId());";
  protected final String TEXT_73 = NL;
  protected final String TEXT_74 = "      for (Match match : matches) {";
  protected final String TEXT_75 = NL;
  protected final String TEXT_76 = "        match = match.append(vertex.getId());";
  protected final String TEXT_77 = NL;
  protected final String TEXT_78 = "        if (!match.isInjective()) {";
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = "          continue;";
  protected final String TEXT_81 = NL;
  protected final String TEXT_82 = "        }";
  protected final String TEXT_83 = NL;
  protected final String TEXT_84 = "        if (vertex.getId().compareTo(match.getVertexId(";
  protected final String TEXT_85 = ")) < 0) {";
  protected final String TEXT_86 = NL;
  protected final String TEXT_87 = "          continue;";
  ...
  protected final String TEXT_125 = "        match = match.remove(";
  protected final String TEXT_126 = ");";
  protected final String TEXT_127 = NL;
  protected final String TEXT_128 = "        if (finalMatches.add(match)) {";
  protected final String TEXT_129 = NL;
  protected final String TEXT_130 = "          matchCount++;";
  protected final String TEXT_131 = NL;
  protected final String TEXT_132 = "          if (segment == SEGMENT_COUNT - 1) {";
  protected final String TEXT_133 = NL;
  protected final String TEXT_134 = "            apply";
  protected final String TEXT_135 = "(";
  protected final String TEXT_136 = NL;
  protected final String TEXT_137 = "              vertex, match, appCount++);";
  protected final String TEXT_138 = NL;
  protected final String TEXT_139 = "          } else {";
  protected final String TEXT_140 = NL;
  protected final String TEXT_141 = "            sendMessage(vertex.getId(), match);";
  ...
  protected final String TEXT_151 = "        matchCount++;";
  protected final String TEXT_152 = NL;
  protected final String TEXT_153 = "        // Send the match along all \"";
  protected final String TEXT_154 = "\"-edges:";
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = "        for (Edge<VertexId, ByteWritable> edge : vertex.getEdges()) {";
  protected final String TEXT_157 = NL;
  protected final String TEXT_158 = "          if (edge.getValue().get() ==";
  protected final String TEXT_159 = NL;
  protected final String TEXT_160 = "            ";
  protected final String TEXT_161 = ") {";
  protected final String TEXT_162 = NL;
  protected final String TEXT_163 = "            LOG.info(\"Vertex \" + vertex.getId() +";
  protected final String TEXT_164 = NL;
  protected final String TEXT_165 = "              \" sending (partial) match \" + match +";
  protected final String TEXT_166 = NL;
  protected final String TEXT_167 = "              \" forward to vertex \" + edge.getTargetVertexId());";
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = "            sendMessage(edge.getTargetVertexId(), match);";
  ...
  protected final String TEXT_177 = NL + "      // Keep matches received at node ";
  protected final String TEXT_178 = ":" + NL + "      for (Match match : matches) {" + NL + "        VertexId id = match.getVertexId(";
  protected final String TEXT_179 = ");" + NL + "        if (vertex.getId().equals(id)) {" + NL + "          matchCount++;";
  protected final String TEXT_180 = NL + "          LOG.info(\"Vertex \" + id + \" in superstep \" + getSuperstep() +" + NL + "            \" sending (partial) match \" + match + \" to myself\");";
  protected final String TEXT_181 = NL + "          sendMessage(id, match);" + NL + "        }" + NL + "      }";
  protected final String TEXT_182 = NL + "    }";
  protected final String TEXT_183 = " else {" + NL + "      throw new RuntimeException(\"Illegal microstep for rule \" +" + NL + "        \"";
  protected final String TEXT_184 = ": \" + microstep);" + NL + "    }" + NL + "    if (matchCount > 0) {" + NL + "      aggregate(AGGREGATOR_MATCHES," + NL + "        new LongWritable(matchCount));" + NL + "    }" + NL + "    if (appCount > 0) {" + NL + "      aggregate(AGGREGATOR_RULE_APPLICATIONS," + NL + "        new LongWritable(appCount));" + NL + "    }" + NL + "  }" + NL + "" + NL + "  /**" + NL + "   * Filter matches per segment for the rule \"";
  protected final String TEXT_185 = "\"." + NL + "   * @param vertex The current vertex." + NL + "   * @param matches The current matches." + NL + "   * @param segment The current segment." + NL + "   * @param microstep The current microstep." + NL + "   * @param finalMatches Set of final matches." + NL + "   * @return The filtered matches." + NL + "   */" + NL + "  protected Iterable<Match> filter";
  protected final String TEXT_186 = "(" + NL + "    Vertex<VertexId, ByteWritable, ByteWritable> vertex," + NL + "    Iterable<Match> matches, int segment, int microstep," + NL + "    Set<Match> finalMatches)" + NL + "    throws IOException {" + NL + "    if (segment > 0) {" + NL + "      List<Match> filtered = new ArrayList<Match>();" + NL + "      long matchCount = 0;" + NL + "      long appCount = 0;" + NL + "      for (Match match : matches) {" + NL + "        int matchSegment = match.getSegment();" + NL + "        if (matchSegment < segment) {" + NL + "          if (!finalMatches.add(match)) {" + NL + "            continue;" + NL + "          }" + NL + "          matchCount++;" + NL + "          if (segment == SEGMENT_COUNT - 1 && microstep == ";
  protected final String TEXT_187 = ") {" + NL + "            apply";
  protected final String TEXT_188 = "(" + NL + "              vertex, match, appCount++);" + NL + "          } else {" + NL + "            sendMessage(vertex.getId(), match);" + NL + "          }" + NL + "        } else if (matchSegment > segment) {" + NL + "          throw new RuntimeException(\"Received match \" + match +" + NL + "            \" of rule ";
  protected final String TEXT_189 = " of segment \" +" + NL + "            matchSegment + \", but current segment is only \" + segment);" + NL + "        } else {" + NL + "          filtered.add(match.copy());" + NL + "        }" + NL + "      }" + NL + "      if (matchCount > 0) {" + NL + "        aggregate(AGGREGATOR_MATCHES," + NL + "          new LongWritable(matchCount));" + NL + "      }" + NL + "      if (appCount > 0) {" + NL + "        aggregate(AGGREGATOR_RULE_APPLICATIONS," + NL + "          new LongWritable(appCount));" + NL + "      }" + NL + "      return filtered;" + NL + "    }" + NL + "    return matches;" + NL + "  }" + NL + "" + NL + "  /**" + NL + "   * Apply the rule \"";
  protected final String TEXT_190 = "\" to a given match." + NL + "   * @param vertex The base vertex." + NL + "   * @param match The match object." + NL + "   * @param matchIndex Match index." + NL + "   * @return true if the rule was applied." + NL + "   * @throws IOException On I/O errors." + NL + "   */" + NL + "  protected boolean apply";
  protected final String TEXT_191 = "(" + NL + "    Vertex<VertexId, ByteWritable, ByteWritable> vertex," + NL + "    Match match, long matchIndex) throws IOException {";
  protected final String TEXT_192 = NL + "    VertexId cur";
  protected final String TEXT_193 = " = match.getVertexId(";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "    LOG.info(\"Vertex \" + vertex.getId() +" + NL + "      \" applying rule ";
  protected final String TEXT_196 = " with match \" + match);";
  protected final String TEXT_197 = NL + "    removeEdgesRequest(cur";
  protected final String TEXT_198 = ", cur";
  protected final String TEXT_199 = ");";
  protected final String TEXT_200 = NL + "    removeVertexRequest(cur";
  protected final String TEXT_201 = ");";
  protected final String TEXT_202 = NL + "    VertexId new";
  protected final String TEXT_203 = " =";
  protected final String TEXT_204 = NL + "      VertexId.randomVertexId();";
  protected final String TEXT_205 = NL + "      deriveVertexId(vertex.getId(), (int) matchIndex, ";
  protected final String TEXT_206 = ");";
  protected final String TEXT_207 = NL + "    addVertexRequest(new";
  protected final String TEXT_208 = "," + NL + "      new ByteWritable(";
  protected final String TEXT_209 = "));";
  protected final String TEXT_210 = NL + "    VertexId src";
  protected final String TEXT_211 = " = new";
  protected final String TEXT_212 = ";";
  protected final String TEXT_213 = NL + "    VertexId src";
  ...
  protected final String TEXT_219 = NL + "    VertexId trg";
  protected final String TEXT_220 = " = cur";
  protected final String TEXT_221 = ";";
  protected final String TEXT_222 = NL + "    Edge<VertexId, ByteWritable> edge";
  protected final String TEXT_223 = " =" + NL + "      EdgeFactory.create(trg";
  protected final String TEXT_224 = "," + NL + "        new ByteWritable(";
  protected final String TEXT_225 = "));" + NL + "    addEdgeRequest(src";
  protected final String TEXT_226 = ", edge";
  protected final String TEXT_227 = ");";
  protected final String TEXT_228 = NL + "    return true;" + NL + "  }";
  protected final String TEXT_229 = NL;
  protected final String TEXT_230 = NL + "  /**" + NL + "   * Derive a new vertex Id from an exiting one." + NL + "   * @param baseId The base vertex Id." + NL + "   * @param matchIndex The index of the match." + NL + "   * @param vertexIndex The index of the new vertex." + NL + "   * @return The derived vertex Id." + NL + "   */" + NL + "  private VertexId deriveVertexId(VertexId baseId, int matchIndex," + NL + "    int vertexIndex) {" + NL + "    long generation = ((LongWritable) getAggregatedValue(" + NL + "        AGGREGATOR_NODE_GENERATION)).get();" + NL + "    return baseId" + NL + "      .append((byte) generation)" + NL + "      .append((byte) matchIndex)" + NL + "      .append((byte) vertexIndex);" + NL + "  }" + NL;
  protected final String TEXT_231 = NL + "  /**" + NL + "   * Get the segment that a vertex belongs to." + NL + "   * @param vertexId The ID of the vertex." + NL + "   * @return The segment of the vertex." + NL + "   */" + NL + "  private int getSegment(VertexId vertexId) {" + NL + "    return vertexId.hashCode() % SEGMENT_COUNT;" + NL + "  }" + NL + "" + NL + "  /**" + NL + "   * Master compute which registers and updates the required aggregators." + NL + "   */" + NL + "  public static class MasterCompute extends DefaultMasterCompute {" + NL + "" + NL + "    /**" + NL + "     * Stack for storing unit success flags." + NL + "     */" + NL + "    private final Deque<Boolean> unitSuccesses =" + NL + "      new ArrayDeque<Boolean>();" + NL + "" + NL + "    /**" + NL + "     * Stack for storing the execution orders of independent units." + NL + "     */" + NL + "    private final Deque<List<Integer>> unitOrders =" + NL + "      new ArrayDeque<List<Integer>>();" + NL + "" + NL + "    /*" + NL + "     * (non-Javadoc)" + NL + "     * @see org.apache.giraph.master.DefaultMasterCompute#compute()" + NL + "     */" + NL + "    @Override" + NL + "    public void compute() {" + NL + "      long ruleApps = ((LongWritable)" + NL + "        getAggregatedValue(AGGREGATOR_RULE_APPLICATIONS)).get();";
  protected final String TEXT_232 = NL + "      long matches = ((LongWritable)" + NL + "        getAggregatedValue(AGGREGATOR_MATCHES)).get();" + NL + "      if (getSuperstep() > 0) {" + NL + "        LOG.info(matches + \" (partial) matches computed and \" +" + NL + "          ruleApps + \" rule applications conducted in superstep \" +" + NL + "          (getSuperstep() - 1));" + NL + "      }";
  ...
  protected final String TEXT_234 = ", 0, 0);";
  protected final String TEXT_235 = NL + "        stack = nextRuleStep(stack, ruleApps);";
  protected final String TEXT_236 = NL + "      } else {" + NL + "        stack = getAggregatedValue(AGGREGATOR_APPLICATION_STACK);" + NL + "        stack = nextRuleStep(stack, ruleApps);" + NL + "      }" + NL + "      setAggregatedValue(AGGREGATOR_APPLICATION_STACK, stack);" + NL + "    }" + NL + "" + NL + "    /**" + NL + "     * Compute the next rule application stack." + NL + "     * @param stack The current application stack." + NL + "     * @param ruleApps Number of rule applications in last superstep." + NL + "     * @return The new application stack." + NL + "     */" + NL + "    private ApplicationStack nextRuleStep(" + NL + "      ApplicationStack stack, long ruleApps) {" + NL + "      while (stack.getStackSize() > 0) {" + NL + "        int unit = stack.getLastUnit();" + NL + "        int segment = stack.getLastSegment();" + NL + "        int microstep = stack.getLastMicrostep();" + NL + "        stack = stack.removeLast();" + NL + "        switch (unit) {";
  protected final String TEXT_237 = NL + "        case ";
  protected final String TEXT_238 = ":" + NL + "          stack = process";
  protected final String TEXT_239 = "(" + NL + "            stack";
  protected final String TEXT_240 = ", microstep";
  protected final String TEXT_241 = ");" + NL + "          break;";
  protected final String TEXT_242 = NL + "        default:" + NL + "          throw new RuntimeException(\"Unknown unit \" + unit);" + NL + "        }" + NL + "        if (stack.getStackSize() > 0) {" + NL + "          unit = stack.getLastUnit();";
  protected final String TEXT_243 = NL + "          ";
  protected final String TEXT_244 = "unit == ";
  protected final String TEXT_245 = NL + "            break;" + NL + "          }" + NL + "        }" + NL + "      }" + NL + "      return stack;" + NL + "    }";
  protected final String TEXT_246 = NL + NL + "   /**" + NL + "     * Process ";
  protected final String TEXT_247 = " \"";
  protected final String TEXT_248 = "\"." + NL + "     * @param stack The current application stack.";
  protected final String TEXT_249 = NL + "     * @param segment The current segment.";
  protected final String TEXT_250 = NL + "     * @param microstep The current microstep.";
  protected final String TEXT_251 = NL + "     * @param ruleApps Number of rule applications in last superstep.";
  protected final String TEXT_252 = NL + "     * @return The new application stack." + NL + "     */" + NL + "    private ApplicationStack process";
  protected final String TEXT_253 = "(" + NL + "      ApplicationStack stack";
  protected final String TEXT_254 = ", int microstep";
  protected final String TEXT_255 = ") {";
  protected final String TEXT_256 = NL + "      if (microstep > 0 && !unitSuccesses.pop()) {" + NL + "        unitSuccesses.push(false);" + NL + "      } else if (microstep == ";
  protected final String TEXT_257 = ") {" + NL + "        unitSuccesses.push(true);" + NL + "      } else if (microstep < ";
  protected final String TEXT_258 = ") {" + NL + "        stack = stack.append(";
  protected final String TEXT_259 = ", 0, microstep + 1);" + NL + "        stack = stack.append(";
  protected final String TEXT_260 = ", 0, 0);" + NL + "      }";
  protected final String TEXT_261 = NL + "      if (microstep > 0 && !unitSuccesses.pop()) {" + NL + "        unitSuccesses.push(false);" + NL + "      } else if (microstep == ";
  protected final String TEXT_262 = ") {" + NL + "        unitSuccesses.push(true);" + NL + "      } else {" + NL + "        switch (microstep) {";
  ...
  protected final String TEXT_267 = ", 0, 0);" + NL + "          break;";
  protected final String TEXT_268 = NL + "        default:" + NL + "          break;" + NL + "        }" + NL + "      }";
  protected final String TEXT_269 = NL + "      if (microstep == 0) {" + NL + "        List<Integer> order = new ArrayList<Integer>();" + NL + "        for (int i = 0; i < ";
  protected final String TEXT_270 = "; i++) {" + NL + "          order.add(i);" + NL + "        }" + NL + "        Collections.shuffle(order);" + NL + "        unitOrders.push(order);" + NL + "      }" + NL + "      if (microstep > 0 && unitSuccesses.pop()) {" + NL + "        unitOrders.pop();" + NL + "        unitSuccesses.push(true);" + NL + "      } else if (microstep == ";
  protected final String TEXT_271 = ") {" + NL + "        unitOrders.pop();" + NL + "        unitSuccesses.push(false);" + NL + "      } else {" + NL + "        int next = unitOrders.peek().get(microstep);" + NL + "        switch (next) {";
  protected final String TEXT_272 = NL + "        case ";
  protected final String TEXT_273 = ":" + NL + "          stack = stack.append(";
  protected final String TEXT_274 = ", 0, microstep + 1);" + NL + "          stack = stack.append(";
  protected final String TEXT_275 = ", 0, 0);" + NL + "          break;";
  protected final String TEXT_276 = NL + "        default:" + NL + "          break;" + NL + "        }" + NL + "      }";
  protected final String TEXT_277 = NL + "      if (microstep == 0 || unitSuccesses.pop()) {" + NL + "        stack = stack.append(";
  protected final String TEXT_278 = ", 0, 1);" + NL + "        stack = stack.append(";
  protected final String TEXT_279 = ", 0, 0);" + NL + "      } else {" + NL + "        unitSuccesses.push(true);" + NL + "      }";
  protected final String TEXT_280 = NL + "      if (microstep < ";
  protected final String TEXT_281 = ") {" + NL + "        stack = stack.append(";
  protected final String TEXT_282 = ", segment, microstep + 1);" + NL + "      } else if (segment < SEGMENT_COUNT - 1) {" + NL + "        stack = stack.append(";
  protected final String TEXT_283 = ", segment + 1, 0);" + NL + "      } else {" + NL + "        unitSuccesses.push(ruleApps > 0);" + NL + "      }";
  protected final String TEXT_284 = NL + "      return stack;" + NL + "    }";
  protected final String TEXT_285 = NL + NL + "    /*" + NL + "     * (non-Javadoc)" + NL + "     * @see org.apache.giraph.master.DefaultMasterCompute#initialize()" + NL + "     */" + NL + "    @Override" + NL + "    public void initialize() throws InstantiationException," + NL + "        IllegalAccessException {" + NL + "      registerAggregator(AGGREGATOR_MATCHES," + NL + "        LongSumAggregator.class);" + NL + "      registerAggregator(AGGREGATOR_RULE_APPLICATIONS," + NL + "        LongSumAggregator.class);" + NL + "      registerPersistentAggregator(AGGREGATOR_NODE_GENERATION," + NL + "        LongSumAggregator.class);" + NL + "      registerPersistentAggregator(AGGREGATOR_APPLICATION_STACK," + NL + "        ApplicationStackAggregator.class);" + NL + "    }" + NL + "" + NL + "  }" + NL + "}";
