 ...
 *        annotation="http://www.eclipse.org/emf/2010/Henshin/OCL ValidName='not self.name.oclIsUndefined() implies self.name<>\'\'' ValidName.Msg='If a name for an entity is set, the name must not be an empty string. \r\nInstead, you may want to use \"Restore default value\" in the properties view.' ValidName.Severity='Warning'"
 * @generated
 */
