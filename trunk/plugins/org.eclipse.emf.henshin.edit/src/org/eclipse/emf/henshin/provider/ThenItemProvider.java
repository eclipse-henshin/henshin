 ...
 * {@link HenshinPackage#CONDITIONAL_UNIT__THEN}. <br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @author Stefan Jurack (sjurack)
 * 
 */
public class ThenItemProvider extends TransientItemProvider {
	
	/**
	 * @param adapterFactory
	 * @param target
	 */
	public ThenItemProvider(AdapterFactory adapterFactory, EObject target) {
	...
	protected EStructuralFeature getChildFeature(Object object, Object child) {
		if (isValidValue(target, child, HenshinPackage.Literals.CONDITIONAL_UNIT__THEN)) {
			return HenshinPackage.Literals.CONDITIONAL_UNIT__THEN;
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ConditionalUnit_then_feature");
	}// getText
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location,
		...
		return new NonContainmentTransientIPDragAndDropCommand(domain, (TransformationUnit) target,
				HenshinPackage.Literals.CONDITIONAL_UNIT__THEN, collection);
