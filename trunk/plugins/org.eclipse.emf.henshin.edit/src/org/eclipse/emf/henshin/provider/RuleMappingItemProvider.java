 ...
 * 
 */
public class RuleMappingItemProvider extends TransientItemProvider {
	
	/**
	 * @param adapterFactory
	 * @param target
	 */
	public RuleMappingItemProvider(AdapterFactory adapterFactory, EObject target) {
	...
	public String getText(Object object) {
		return getString("_UI_Rule_mappings_feature");
	}// getText
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location,
		...
		if (new AddCommand(domain, (EObject) owner,
				HenshinPackage.Literals.RULE__MAPPINGS, collection).canExecute())
