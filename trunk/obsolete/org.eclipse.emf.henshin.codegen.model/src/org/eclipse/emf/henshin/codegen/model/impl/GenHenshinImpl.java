 ...
 *   <li>{@link org.eclipse.emf.henshin.codegen.model.impl.GenHenshinImpl#isSuppressInterfaces <em>Suppress Interfaces</em>}</li>
...
public class GenHenshinImpl extends EObjectImpl implements GenHenshin {
	...
	public void setSuppressInterfaces(boolean newSuppressInterfaces) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenHenshinPackage.GEN_HENSHIN__SUPPRESS_INTERFACES, oldSuppressInterfaces, suppressInterfaces));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GenHenshinPackage.GEN_HENSHIN__SUPPRESS_INTERFACES:
