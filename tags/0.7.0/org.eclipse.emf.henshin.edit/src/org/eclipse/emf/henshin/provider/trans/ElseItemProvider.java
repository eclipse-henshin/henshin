 ...
 * 
 */
public class ElseItemProvider extends TransientItemProvider {
	
	/**
	 * @param adapterFactory
	 * @param target
	 */
	public ElseItemProvider(AdapterFactory adapterFactory, EObject target) {
	...
	protected EStructuralFeature getChildFeature(Object object, Object child) {
		if (isValidValue(target, child, HenshinPackage.Literals.CONDITIONAL_UNIT__ELSE)) {
			return HenshinPackage.Literals.CONDITIONAL_UNIT__ELSE;
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ConditionalUnit_else_feature");
	}// getText
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location,
		...
		return new NonContainmentTransientIPDragAndDropCommand(domain, (TransformationUnit) target,
				HenshinPackage.Literals.CONDITIONAL_UNIT__ELSE, collection);
