...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.henshin.model.TransformationSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationSystemItemProvider
...
//				 HenshinFactory.eINSTANCE.createRule()));
	...
	protected Command createAddCommand(EditingDomain domain, EObject owner, EStructuralFeature feature, Collection<?> collection, int index) {
		if (feature==HenshinPackage.eINSTANCE.getTransformationSystem_Rules()) {
			return new AddRuleCommand(domain, (TransformationSystem) owner, (Collection<Rule>) collection, index);
		} else {
