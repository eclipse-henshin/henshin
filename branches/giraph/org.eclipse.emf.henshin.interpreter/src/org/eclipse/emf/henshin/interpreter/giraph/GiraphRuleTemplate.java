...
public class GiraphRuleTemplate
{
  ...
  protected final String TEXT_49 = "(vertex, match, appliedMatches);";
  protected final String TEXT_50 = NL + "          }" + NL + "        }" + NL + "      }";
  protected final String TEXT_51 = NL + "      // Joining matches at node ";
  protected final String TEXT_52 = ":";
  protected final String TEXT_53 = NL + "      LOG.info(\"Vertex \" + vertex.getId() + \" in superstep \" + getSuperstep() +" + NL + "        \" joining matches of rule ";
  protected final String TEXT_54 = "\");";
  protected final String TEXT_55 = NL + "      for (Match m1 : matches) {" + NL + "        VertexId id1 = m1.getVertexId(";
  protected final String TEXT_56 = ");" + NL + "        if (vertex.getId().equals(id1)) {" + NL + "          for (Match m2 : matches) {" + NL + "            VertexId id2 = m2.getVertexId(";
  protected final String TEXT_57 = ");" + NL + "            if (!vertex.getId().equals(id2)) {" + NL + "              Match joined = m1.append(m2);";
  protected final String TEXT_58 = NL + "              if (!joined.isInjective()) {" + NL + "                continue;" + NL + "              }";
  protected final String TEXT_59 = NL + "              apply";
  protected final String TEXT_60 = "(vertex, joined, appliedMatches);";
  protected final String TEXT_61 = NL + "            }" + NL + "          }" + NL + "        }" + NL + "      }";
  protected final String TEXT_62 = NL + "      // Matching node ";
  protected final String TEXT_63 = ":" + NL + "      boolean ok = vertex.getValue().get() == ";
  protected final String TEXT_64 = ".get();" + NL + "      if (ok) {";
  protected final String TEXT_65 = NL + "        Match match = new Match().append(vertex.getId());";
  protected final String TEXT_66 = NL;
  protected final String TEXT_67 = "      for (Match match : matches) {";
  protected final String TEXT_68 = NL;
  protected final String TEXT_69 = "        match = match.append(vertex.getId());";
  protected final String TEXT_70 = NL;
  protected final String TEXT_71 = "        if (!match.isInjective()) {";
  protected final String TEXT_72 = NL;
  protected final String TEXT_73 = "          continue;";
  protected final String TEXT_74 = NL;
  protected final String TEXT_75 = "        }";
  protected final String TEXT_76 = NL;
  protected final String TEXT_77 = "        for (Edge<VertexId, ByteWritable> edge : vertex.getEdges()) {";
  ...
  protected final String TEXT_84 = "            LOG.info(\"Vertex \" + vertex.getId() +";
  protected final String TEXT_85 = NL;
  protected final String TEXT_86 = "              \" sending (partial) match \" + match +";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = "              \" forward to vertex \" + edge.getTargetVertexId());";
  protected final String TEXT_89 = NL;
  protected final String TEXT_90 = "            sendMessage(edge.getTargetVertexId(), match);";
  protected final String TEXT_91 = NL;
  protected final String TEXT_92 = "          }";
  protected final String TEXT_93 = NL;
  protected final String TEXT_94 = "        }";
  protected final String TEXT_95 = NL + "          // Send the message back to matches of node ";
  protected final String TEXT_96 = ":" + NL + "          for (Match m : matches) {" + NL + "            VertexId targetId = m.getVertexId(";
  protected final String TEXT_97 = ");";
  protected final String TEXT_98 = NL + "            LOG.info(\"Vertex \" + vertex.getId() +" + NL + "              \" sending (partial) match \" + match +" + NL + "              \" back to vertex \" + targetId);";
  protected final String TEXT_99 = NL + "            sendMessage(targetId, match);" + NL + "          }";
  protected final String TEXT_100 = NL;
  protected final String TEXT_101 = "        apply";
  protected final String TEXT_102 = "(vertex, match, appliedMatches);";
  protected final String TEXT_103 = NL;
  protected final String TEXT_104 = "      }";
  protected final String TEXT_105 = NL + "      }";
  protected final String TEXT_106 = NL + "      // Keep matches received at node ";
  protected final String TEXT_107 = ":" + NL + "      for (Match match : matches) {" + NL + "        VertexId id = match.getVertexId(";
  protected final String TEXT_108 = ");" + NL + "        if (vertex.getId().equals(id)) {";
  protected final String TEXT_109 = NL + "          LOG.info(\"Vertex \" + id + \" in superstep \" + getSuperstep() +" + NL + "            \" sending (partial) match \" + match + \" to myself\");";
  protected final String TEXT_110 = NL + "          sendMessage(id, match);" + NL + "        }" + NL + "      }";
  protected final String TEXT_111 = NL + "    }";
  protected final String TEXT_112 = " else {" + NL + "      throw new RuntimeException(\"Illegal microstep for rule \" +" + NL + "        \"";
  protected final String TEXT_113 = ": \" + microstep);" + NL + "    }" + NL + "  }" + NL + "" + NL + "  /**" + NL + "   * Apply the rule \"";
  protected final String TEXT_114 = "\" to a given match." + NL + "   * @param vertex The base vertex." + NL + "   * @param match The match object." + NL + "   * @param appliedMatches Set of already applied matches." + NL + "   * @return true if the rule was applied." + NL + "   * @throws IOException On I/O errors." + NL + "   */" + NL + "  protected boolean apply";
  protected final String TEXT_115 = "(Vertex<VertexId, ByteWritable," + NL + "    ByteWritable> vertex, Match match, Set<Match> appliedMatches)" + NL + "    throws IOException {";
  protected final String TEXT_116 = NL + "    VertexId cur";
  protected final String TEXT_117 = " = match.getVertexId(";
  protected final String TEXT_118 = ");";
  protected final String TEXT_119 = NL + "    match = match.remove(";
  protected final String TEXT_120 = ");";
  protected final String TEXT_121 = NL + "    if (!appliedMatches.add(match)) {" + NL + "      return false;" + NL + "    }";
  protected final String TEXT_122 = NL + "    LOG.info(\"Vertex \" + vertex.getId() +" + NL + "      \" applying rule ";
  protected final String TEXT_123 = " with match \" + match);";
  protected final String TEXT_124 = NL + "    removeEdgesRequest(cur";
  protected final String TEXT_125 = ", cur";
  protected final String TEXT_126 = ");";
  protected final String TEXT_127 = NL + "    removeVertexRequest(cur";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "    VertexId new";
  protected final String TEXT_130 = " =";
  protected final String TEXT_131 = NL + "      VertexId.randomVertexId();";
  protected final String TEXT_132 = NL + "      deriveVertexId(vertex.getId(), (byte) ";
  protected final String TEXT_133 = ");";
  protected final String TEXT_134 = NL + "    addVertexRequest(new";
  protected final String TEXT_135 = ", ";
  protected final String TEXT_136 = ");";
  protected final String TEXT_137 = NL + "    VertexId src";
  protected final String TEXT_138 = " = new";
  protected final String TEXT_139 = ";";
  protected final String TEXT_140 = NL + "    VertexId src";
  protected final String TEXT_141 = " = cur";
  protected final String TEXT_142 = ";";
  protected final String TEXT_143 = NL + "    VertexId trg";
  protected final String TEXT_144 = " = new";
  protected final String TEXT_145 = ";";
  protected final String TEXT_146 = NL + "    VertexId trg";
  protected final String TEXT_147 = " = cur";
  protected final String TEXT_148 = ";";
  protected final String TEXT_149 = NL + "    Edge<VertexId, ByteWritable> edge";
  protected final String TEXT_150 = " =" + NL + "      EdgeFactory.create(trg";
  protected final String TEXT_151 = ", ";
  protected final String TEXT_152 = ");" + NL + "    addEdgeRequest(src";
  protected final String TEXT_153 = ", edge";
  protected final String TEXT_154 = ");";
  protected final String TEXT_155 = NL + "    aggregate(AGGREGATOR_RULE_APPLICATIONS, new LongWritable(1));" + NL + "    return true;" + NL + "  }";
  protected final String TEXT_156 = NL;
  protected final String TEXT_157 = NL + "  /**" + NL + "   * Derive a new vertex Id from an exiting one." + NL + "   * @param baseId The base vertex Id." + NL + "   * @param vertexIndex The relative index of the new vertex." + NL + "   * @return The derived vertex Id." + NL + "   */" + NL + "  private VertexId deriveVertexId(VertexId baseId, int vertexIndex) {" + NL + "    long generation = ((LongWritable) getAggregatedValue(" + NL + "        AGGREGATOR_NODE_GENERATION)).get();" + NL + "    return baseId.append((byte) generation).append((byte) vertexIndex);" + NL + "  }" + NL;
  protected final String TEXT_158 = NL + "  /**" + NL + "   * Master compute which registers and updates the required aggregators." + NL + "   */" + NL + "  public static class MasterCompute extends DefaultMasterCompute {" + NL + "" + NL + "    /**" + NL + "     * Stack for storing unit success flags." + NL + "     */" + NL + "    private final Deque<Boolean> unitSuccesses =" + NL + "      new ArrayDeque<Boolean>();" + NL + "" + NL + "    /**" + NL + "     * Stack for storing the execution orders of independent units." + NL + "     */" + NL + "    private final Deque<List<Integer>> unitOrders =" + NL + "      new ArrayDeque<List<Integer>>();" + NL + "" + NL + "    /*" + NL + "     * (non-Javadoc)" + NL + "     * @see org.apache.giraph.master.DefaultMasterCompute#compute()" + NL + "     */" + NL + "    @Override" + NL + "    public void compute() {" + NL + "      long ruleApps = ((LongWritable)" + NL + "        getAggregatedValue(AGGREGATOR_RULE_APPLICATIONS)).get();";
  protected final String TEXT_159 = NL + "      if (getSuperstep() > 0) {" + NL + "        LOG.info(ruleApps + \" rule applications in superstep \" +" + NL + "          (getSuperstep() - 1));" + NL + "      }";
  ...
  protected final String TEXT_162 = NL + "        stack = nextRuleStep(stack, ruleApps);";
  protected final String TEXT_163 = NL + "      } else {" + NL + "        stack = getAggregatedValue(AGGREGATOR_APPLICATION_STACK);" + NL + "        stack = nextRuleStep(stack, ruleApps);" + NL + "      }" + NL + "      setAggregatedValue(AGGREGATOR_APPLICATION_STACK, stack);" + NL + "    }" + NL + "" + NL + "    /**" + NL + "     * Compute the next rule application stack." + NL + "     * @param stack Current application stack." + NL + "     * @param ruleApps Number of rule applications in last superstep." + NL + "     * @return the new application stack." + NL + "     */" + NL + "    private ApplicationStack nextRuleStep(" + NL + "      ApplicationStack stack, long ruleApps) {" + NL + "      while (stack.getStackSize() > 0) {" + NL + "        int unit = stack.getLastUnit();" + NL + "        int microstep = stack.getLastMicrostep();" + NL + "        stack = stack.removeLast();" + NL + "        switch (unit) {";
  protected final String TEXT_164 = NL + "        case ";
  protected final String TEXT_165 = ":" + NL + "          stack = process";
  protected final String TEXT_166 = "(" + NL + "            stack, microstep";
  protected final String TEXT_167 = ");" + NL + "          break;";
  protected final String TEXT_168 = NL + "        default:" + NL + "          throw new RuntimeException(\"Unknown unit \" + unit);" + NL + "        }" + NL + "        if (stack.getStackSize() > 0) {" + NL + "          unit = stack.getLastUnit();";
  protected final String TEXT_169 = NL + "          ";
  protected final String TEXT_170 = "unit == ";
  protected final String TEXT_171 = NL + "            break;" + NL + "          }" + NL + "        }" + NL + "      }" + NL + "      return stack;" + NL + "    }";
  protected final String TEXT_172 = NL + NL + "   /**" + NL + "     * Process ";
  protected final String TEXT_173 = " \"";
  protected final String TEXT_174 = "\"." + NL + "     * @param stack Current application stack." + NL + "     * @param microstep Current microstep.";
  protected final String TEXT_175 = NL + "     * @param ruleApps Number of rule applications in last superstep.";
  protected final String TEXT_176 = NL + "     * @return the new application stack." + NL + "     */" + NL + "    private ApplicationStack process";
  protected final String TEXT_177 = "(" + NL + "      ApplicationStack stack, int microstep";
  protected final String TEXT_178 = ") {";
  protected final String TEXT_179 = NL + "      if (microstep > 0 && !unitSuccesses.pop()) {" + NL + "        unitSuccesses.push(false);" + NL + "      } else if (microstep == ";
  protected final String TEXT_180 = ") {" + NL + "        unitSuccesses.push(true);" + NL + "      } else if (microstep < ";
  protected final String TEXT_181 = ") {" + NL + "        stack = stack.append(";
  protected final String TEXT_182 = ", microstep + 1);" + NL + "        stack = stack.append(";
  protected final String TEXT_183 = ", 0);" + NL + "      }";
  protected final String TEXT_184 = NL + "      if (microstep > 0 && !unitSuccesses.pop()) {" + NL + "        unitSuccesses.push(false);" + NL + "      } else if (microstep == ";
  protected final String TEXT_185 = ") {" + NL + "        unitSuccesses.push(true);" + NL + "      } else {" + NL + "        switch (microstep) {";
  protected final String TEXT_186 = NL + "        case ";
  protected final String TEXT_187 = ":" + NL + "          stack = stack.append(";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = ");" + NL + "          stack = stack.append(";
  protected final String TEXT_190 = ", 0);" + NL + "          break;";
  protected final String TEXT_191 = NL + "        default:" + NL + "          break;" + NL + "        }" + NL + "      }";
  protected final String TEXT_192 = NL + "      if (microstep == 0) {" + NL + "        List<Integer> order = new ArrayList<Integer>();" + NL + "        for (int i = 0; i < ";
  protected final String TEXT_193 = "; i++) {" + NL + "          order.add(i);" + NL + "        }" + NL + "        Collections.shuffle(order);" + NL + "        unitOrders.push(order);" + NL + "      }" + NL + "      if (microstep > 0 && unitSuccesses.pop()) {" + NL + "        unitOrders.pop();" + NL + "        unitSuccesses.push(true);" + NL + "      } else if (microstep == ";
  protected final String TEXT_194 = ") {" + NL + "        unitOrders.pop();" + NL + "        unitSuccesses.push(false);" + NL + "      } else {" + NL + "        int next = unitOrders.peek().get(microstep);" + NL + "        switch (next) {";
  protected final String TEXT_195 = NL + "        case ";
  protected final String TEXT_196 = ":" + NL + "          stack = stack.append(";
  protected final String TEXT_197 = ", microstep + 1);" + NL + "          stack = stack.append(";
  protected final String TEXT_198 = ", 0);" + NL + "          break;";
  protected final String TEXT_199 = NL + "        default:" + NL + "          break;" + NL + "        }" + NL + "      }";
  protected final String TEXT_200 = NL + "      if (microstep == 0 || unitSuccesses.pop()) {" + NL + "        stack = stack.append(";
  protected final String TEXT_201 = ", 1);" + NL + "        stack = stack.append(";
  protected final String TEXT_202 = ", 0);" + NL + "      } else {" + NL + "        unitSuccesses.push(true);" + NL + "      }";
  protected final String TEXT_203 = NL + "      if (microstep < ";
  protected final String TEXT_204 = ") {" + NL + "        stack = stack.append(";
  protected final String TEXT_205 = ", microstep + 1);" + NL + "      } else {" + NL + "        unitSuccesses.push(ruleApps > 0);" + NL + "      }";
  protected final String TEXT_206 = NL + "      return stack;" + NL + "    }";
  protected final String TEXT_207 = NL + NL + "    /*" + NL + "     * (non-Javadoc)" + NL + "     * @see org.apache.giraph.master.DefaultMasterCompute#initialize()" + NL + "     */" + NL + "    @Override" + NL + "    public void initialize() throws InstantiationException," + NL + "        IllegalAccessException {" + NL + "      registerAggregator(AGGREGATOR_RULE_APPLICATIONS," + NL + "        LongSumAggregator.class);" + NL + "      registerPersistentAggregator(AGGREGATOR_NODE_GENERATION," + NL + "        LongSumAggregator.class);" + NL + "      registerPersistentAggregator(AGGREGATOR_APPLICATION_STACK," + NL + "        ApplicationStackAggregator.class);" + NL + "    }" + NL + "" + NL + "  }" + NL + "}";
