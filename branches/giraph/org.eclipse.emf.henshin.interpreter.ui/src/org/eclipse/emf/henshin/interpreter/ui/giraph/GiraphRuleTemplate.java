...
public class GiraphRuleTemplate
{
  ...
  protected final String TEXT_50 = ":" + NL + "          for (HenshinUtil.Match m : matches) {" + NL + "            HenshinUtil.VertexId targetVertexId =" + NL + "              HenshinUtil.getMatchVertexId(m, ";
  ...
  protected final String TEXT_61 = ":" + NL + "    removeEdgesRequest(" + NL + "      HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_62 = ")," + NL + "      HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_63 = ")" + NL + "    );";
  protected final String TEXT_64 = NL + NL + "    // Remove vertex ";
  protected final String TEXT_65 = ":" + NL + "    removeVertexRequest(" + NL + "      HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_66 = ")" + NL + "    );";
  protected final String TEXT_67 = NL + "    byte[] thisVertexId = vertex.getId().getBytes();" + NL + "    byte[] newVertexId;";
  protected final String TEXT_68 = NL + NL + "    // Create vertex ";
  ...
  protected final String TEXT_70 = ";" + NL + "    addVertexRequest(new HenshinUtil.VertexId(newVertexId)," + NL + "      new IntWritable(";
  protected final String TEXT_71 = "));";
  protected final String TEXT_72 = NL + NL + "    // Create edge ";
  ...
  protected final String TEXT_76 = ";" + NL + "    HenshinUtil.VertexId src";
  protected final String TEXT_77 = " = new HenshinUtil.VertexId(newVertexId);";
  protected final String TEXT_78 = NL + "    HenshinUtil.VertexId src";
  protected final String TEXT_79 = " = HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_80 = ");";
  protected final String TEXT_81 = NL + "    newVertexId = Arrays.copyOf(thisVertexId, thisVertexId.length + 1);" + NL + "    newVertexId[newVertexId.length - 1] = ";
  protected final String TEXT_82 = ";" + NL + "    HenshinUtil.VertexId trg";
  protected final String TEXT_83 = " = new HenshinUtil.VertexId(newVertexId);";
  protected final String TEXT_84 = NL + "    HenshinUtil.VertexId trg";
  protected final String TEXT_85 = " = HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + "    Edge<HenshinUtil.VertexId, IntWritable> edge";
  protected final String TEXT_88 = " =" + NL + "      EdgeFactory.create(trg";
  protected final String TEXT_89 = ", new IntWritable(";
  protected final String TEXT_90 = "));" + NL + "    addEdgeRequest(src";
  protected final String TEXT_91 = ", edge";
