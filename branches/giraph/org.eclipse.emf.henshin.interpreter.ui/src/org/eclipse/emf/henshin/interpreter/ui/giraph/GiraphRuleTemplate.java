...
public class GiraphRuleTemplate
{
  ...
  protected final String TEXT_1 = "/*" + NL + " * Licensed to the Apache Software Foundation (ASF) under one" + NL + " * or more contributor license agreements.  See the NOTICE file" + NL + " * distributed with this work for additional information" + NL + " * regarding copyright ownership.  The ASF licenses this file" + NL + " * to you under the Apache License, Version 2.0 (the" + NL + " * \"License\"); you may not use this file except in compliance" + NL + " * with the License.  You may obtain a copy of the License at" + NL + " *" + NL + " *     http://www.apache.org/licenses/LICENSE-2.0" + NL + " *" + NL + " * Unless required by applicable law or agreed to in writing, software" + NL + " * distributed under the License is distributed on an \"AS IS\" BASIS," + NL + " * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied." + NL + " * See the License for the specific language governing permissions and" + NL + " * limitations under the License." + NL + " */" + NL + "package org.apache.giraph.examples;" + NL + "" + NL + "import java.io.IOException;" + NL + "import java.util.Iterator;" + NL + "import java.util.List;" + NL + "import java.util.ArrayList;" + NL + "" + NL + "import org.apache.giraph.edge.Edge;" + NL + "import org.apache.giraph.edge.EdgeFactory;" + NL + "import org.apache.giraph.graph.BasicComputation;" + NL + "import org.apache.giraph.graph.Vertex;" + NL + "import org.apache.hadoop.io.IntWritable;" + NL + "import org.apache.log4j.Logger;" + NL + "" + NL + "/**" + NL + " * Generated implementation of the Henshin rule \"";
  ...
  protected final String TEXT_11 = ") {" + NL + "      LOG.info(\"Vertex \" + vertex.getId() + \" finished with \" +" + NL + "        getTotalNumVertices() + \" vertices and \" +" + NL + "        getTotalNumEdges() + \" edges\");" + NL + "      vertex.voteToHalt();" + NL + "      return;" + NL + "    }" + NL + "" + NL + "    // Log partial matches:" + NL + "    for (HenshinUtil.Match match : matches) {" + NL + "      LOG.info(\"Vertex \" + vertex.getId() +" + NL + "        \" received (partial) match: \" + match);" + NL + "    }" + NL + NL;
  ...
  protected final String TEXT_18 = "\":" + NL + "      List<HenshinUtil.Match> validMatches = new ArrayList<HenshinUtil.Match>();" + NL + "      Iterator<HenshinUtil.Match> it = matches.iterator();" + NL + "      while (it.hasNext()) {" + NL + "        HenshinUtil.Match match = it.next();" + NL + "        HenshinUtil.VertexId targetId = match.getVertexId(";
  protected final String TEXT_19 = ");" + NL + "        for (Edge<HenshinUtil.VertexId, IntWritable> edge :" + NL + "          vertex.getEdges()) {" + NL + "          if (edge.getValue().get() == ";
  ...
  protected final String TEXT_25 = NL + "        // Create a new partial match:" + NL + "        HenshinUtil.Match match =" + NL + "          new HenshinUtil.Match().extend(vertex.getId());";
  protected final String TEXT_26 = NL + "        // Extend all partial matches:" + NL + "        for (HenshinUtil.Match match : matches) {" + NL + "          match = match.extend(vertex.getId());";
  protected final String TEXT_27 = NL;
  protected final String TEXT_28 = "        // Send a match request to all outgoing edges of type \"";
  protected final String TEXT_29 = "\":";
  protected final String TEXT_30 = NL;
  protected final String TEXT_31 = "        for (Edge<HenshinUtil.VertexId, IntWritable> edge :";
  protected final String TEXT_32 = NL;
  protected final String TEXT_33 = "          vertex.getEdges()) {";
  protected final String TEXT_34 = NL;
  protected final String TEXT_35 = "          if (edge.getValue().get() == ";
  protected final String TEXT_36 = ") {";
  protected final String TEXT_37 = NL;
  protected final String TEXT_38 = "            LOG.info(\"Vertex \" + vertex.getId() +";
  protected final String TEXT_39 = NL;
  protected final String TEXT_40 = "              \" sending (partial) match \" + match +";
  protected final String TEXT_41 = NL;
  protected final String TEXT_42 = "              \" to vertex \" + edge.getTargetVertexId());";
  protected final String TEXT_43 = NL;
  protected final String TEXT_44 = "            sendMessage(edge.getTargetVertexId(), match);";
  protected final String TEXT_45 = NL;
  protected final String TEXT_46 = "          }";
  protected final String TEXT_47 = NL;
  protected final String TEXT_48 = "        }";
  protected final String TEXT_49 = NL + "          // Send the message back to matches of node ";
  protected final String TEXT_50 = ":" + NL + "          for (HenshinUtil.Match m : matches) {" + NL + "            HenshinUtil.VertexId targetVertexId =" + NL + "              m.getVertexId(";
  protected final String TEXT_51 = ");" + NL + "            LOG.info(\"Vertex \" + vertex.getId() +" + NL + "              \" sending (partial) match \" + match +" + NL + "              \" to vertex \" + targetVertexId);" + NL + "            sendMessage(targetVertexId, match);" + NL + "          }";
  protected final String TEXT_52 = NL + "        }";
  protected final String TEXT_53 = NL + "      } // end if ok" + NL;
  protected final String TEXT_54 = NL + "      // Apply rule for all matches:" + NL + "      for (HenshinUtil.Match match : matches) {" + NL + "        applyRule(vertex, match);" + NL + "      }";
  protected final String TEXT_55 = NL + "      // In the last iteration the vertex can be made inactive:" + NL + "      if (superstep / ";
  protected final String TEXT_56 = " == applicationCount - 1) {" + NL + "        vertex.voteToHalt();" + NL + "      }";
  protected final String TEXT_57 = NL + NL + "    }";
  protected final String TEXT_58 = NL + NL + "  }" + NL + "" + NL + "  /**" + NL + "   * Apply the rule to a given match." + NL + "   * @param vertex The base vertex." + NL + "   * @param match The match object." + NL + "   * @throws IOException On I/O errors." + NL + "   */" + NL + "  private void applyRule(Vertex<HenshinUtil.VertexId, IntWritable," + NL + "    IntWritable> vertex, HenshinUtil.Match match) throws IOException {" + NL + "" + NL + "    LOG.info(\"Vertex \" + vertex.getId() +" + NL + "      \" applying rule with match \" + match);";
  protected final String TEXT_59 = NL + NL + "    // Remove edge ";
  protected final String TEXT_60 = " -> ";
  protected final String TEXT_61 = ":" + NL + "    removeEdgesRequest(" + NL + "      match.getVertexId(";
  protected final String TEXT_62 = ")," + NL + "      match.getVertexId(";
  protected final String TEXT_63 = ")" + NL + "    );";
  protected final String TEXT_64 = NL + NL + "    // Remove vertex ";
  protected final String TEXT_65 = ":" + NL + "    removeVertexRequest(" + NL + "      match.getVertexId(";
  protected final String TEXT_66 = ")" + NL + "    );";
  protected final String TEXT_67 = NL + NL + "    // Create vertex ";
  protected final String TEXT_68 = ":" + NL + "    addVertexRequest(vertex.getId().extend((byte) ";
  protected final String TEXT_69 = ")," + NL + "      new IntWritable(";
  protected final String TEXT_70 = "));";
  protected final String TEXT_71 = NL + NL + "    // Create edge ";
  protected final String TEXT_72 = " -> ";
  protected final String TEXT_73 = ":";
  protected final String TEXT_74 = NL + "    HenshinUtil.VertexId src";
  protected final String TEXT_75 = " = vertex.getId().extend((byte) ";
  protected final String TEXT_76 = ");";
  protected final String TEXT_77 = NL + "    HenshinUtil.VertexId src";
  protected final String TEXT_78 = " = match.getVertexId(";
  protected final String TEXT_79 = ");";
  protected final String TEXT_80 = NL + "    HenshinUtil.VertexId trg";
  protected final String TEXT_81 = " = vertex.getId().extend((byte) ";
  protected final String TEXT_82 = ");";
  protected final String TEXT_83 = NL + "    HenshinUtil.VertexId trg";
  protected final String TEXT_84 = " = match.getVertexId(";
  protected final String TEXT_85 = ");";
  protected final String TEXT_86 = NL + "    Edge<HenshinUtil.VertexId, IntWritable> edge";
  protected final String TEXT_87 = " =" + NL + "      EdgeFactory.create(trg";
  protected final String TEXT_88 = ", new IntWritable(";
  protected final String TEXT_89 = "));" + NL + "    addEdgeRequest(src";
