...
public class GiraphRuleTemplate
{
  ...
  protected final String TEXT_34 = "            LOG.info(\"Sending partial match: \" +";
  protected final String TEXT_35 = NL;
  protected final String TEXT_36 = "              HenshinUtil.matchToString(match));";
  protected final String TEXT_37 = NL;
  protected final String TEXT_38 = "            sendMessage(edge.getTargetVertexId(), match);";
  ...
  protected final String TEXT_56 = ")," + NL + "      HenshinUtil.getMatchVertexId(match, ";
  protected final String TEXT_57 = ")" + NL + "    );";
  protected final String TEXT_58 = NL + NL + "    // Remove vertex ";
  protected final String TEXT_59 = ":" + NL + "    removeVertexRequest(" + NL + "      HenshinUtil.getMatchVertexId(match, ";
  ...
  protected final String TEXT_85 = ", edge";
  protected final String TEXT_86 = ");";
  protected final String TEXT_87 = NL + NL + "  }" + NL + "" + NL + "}";
