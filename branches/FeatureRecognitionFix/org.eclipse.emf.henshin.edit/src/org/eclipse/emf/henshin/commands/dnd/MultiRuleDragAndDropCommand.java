 ...
 * 
 */
public class MultiRuleDragAndDropCommand extends AbstractCommand implements DragAndDropFeedback {
	 ...
	 * @param collection
	 */
	public MultiRuleDragAndDropCommand(EditingDomain domain, AmalgamationUnit amalgUnit,
