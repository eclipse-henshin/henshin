 ...
 * <li>htRuleApp	 			-- corresponding {@link RuleApplicationImpl}</li>
 * <li>htTransUnit	 			-- {@link TransformationUnit}</li>
 * <li>htUnitApp	 			-- corresponding {@link UnitApplicationImpl}</li>
 * </ul>
 * 
 * @author Felix Rieger
...
public class HenshinTest {
	...
	/**
	 * When calling loadRule(), this will be the {@link RuleApplicationImpl} created
	 * from engine and the loaded {@link Rule}.
	 */
	protected RuleApplicationImpl htRuleApp; // corresponding RuleApplication
	/**
	...
	/**
	 * When calling loadTu(), this will be the {@link UnitApplicationImpl} created
	 * from engine and the loaded {@link TransformationUnit}.
	 */
	protected UnitApplicationImpl htUnitApp; // corresponding UnitApplication
	/**
	...
	protected void loadRule(String ruleName) {
		...
		htRuleApp = new RuleApplicationImpl(htEngine, htRule);
	}
	...
	protected void loadTu(String unitName) {
		...
		htUnitApp = new UnitApplicationImpl(htEngine, htTransUnit);
	}
