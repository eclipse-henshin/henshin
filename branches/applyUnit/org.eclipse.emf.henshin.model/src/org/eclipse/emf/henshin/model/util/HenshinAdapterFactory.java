...
public class HenshinAdapterFactory extends AdapterFactoryImpl {
	...
	protected HenshinSwitch<Adapter> modelSwitch =
		new HenshinSwitch<Adapter>() {
			...
			@Override
			public Adapter caseApplicator(Applicator object) {
				return createApplicatorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.henshin.model.Applicator <em>Applicator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
