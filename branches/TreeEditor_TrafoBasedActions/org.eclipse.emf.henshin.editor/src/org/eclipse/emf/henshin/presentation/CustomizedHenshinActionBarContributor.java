...
import org.eclipse.emf.henshin.editor.transformationCommands.TC_AddMappedNode;
import org.eclipse.emf.henshin.editor.transformationCommands.TC_CreateEdge;
...
public class CustomizedHenshinActionBarContributor extends HenshinActionBarContributor implements
	...
	protected void buildContributions(IMenuManager menuManager) {
		...
		TC_AddMappedNode.INSTANCE.buildContributions(menuManager, currentSelection, domain);
		
		TC_CreateEdge.INSTANCE.buildContributions(menuManager, currentSelection, domain);
		
		SimpleCommandMenuContributor.INSTANCE.buildContributions(menuManager, currentSelection,
				domain);
		// EdgeCommandMenuContributor.INSTANCE.buildContributions(menuManager,
		// currentSelection,
		// domain);
		//
