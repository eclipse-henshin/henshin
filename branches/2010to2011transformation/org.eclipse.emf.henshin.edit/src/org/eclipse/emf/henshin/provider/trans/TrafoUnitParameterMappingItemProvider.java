...
/**
 * This is the item provider for a {@link ParameterMapping} object being referred to by
 * a {@link TransformationUnit}, in fact by its feature
 * {@link HenshinPackage#TRANSFORMATION_UNIT__PARAMETER_MAPPINGS}. <br>
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @author Stefan Jurack (sjurack)
 * 
 */
public class TrafoUnitParameterMappingItemProvider extends TransientItemProvider {
	
	/**
	 * @param adapterFactory
	 * @param target
	 */
	public TrafoUnitParameterMappingItemProvider(AdapterFactory adapterFactory, EObject target) {
	...
	public String getText(Object object) {
		return getString("_UI_TransformationUnit_parameterMappings_feature");
	}// getText
	...
	protected Command createDragAndDropCommand(EditingDomain domain, Object owner, float location,
		...
		if (new AddCommand(domain, (EObject) owner,
				HenshinPackage.Literals.TRANSFORMATION_UNIT__PARAMETER_MAPPINGS, collection).canExecute())
	...
	protected Command createRemoveCommand(EditingDomain domain, EObject owner,
		...
		// commands
		if (feature == HenshinPackage.Literals.TRANSFORMATION_UNIT__PARAMETER_MAPPINGS)
